      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 right-0 z-40 mt-24 flex h-[96%] w-full flex-col rounded-t-[10px] bg-white md:h-full md:w-[400px]">
            ...
            <div className="mb-24 flex-1 overflow-auto bg-white p-4 md:mb-10">
              {user?.email ? (
                ...
                <div className="absolute bottom-16 flex justify-center w-full pr-20 bg-white">
                  <button
                    className="w-full bg-sky-100 rounded-lg p-4 flex gap-4 items-center justify-center"
                    onClick={signIn}
                  >
              ...
              {loading ? (
                ...
                <div className="mx-auto max-w-md">
                  <Drawer.Title className="mb-4 font-medium">Your notes</Drawer.Title>
          ...
          <div className="absolute bottom-0 mt-auto flex w-full justify-between border-t border-zinc-200 bg-zinc-100 p-4">
            <div className="gap-1 flex items-center text-xs text-zinc-600">
              Made with love by{" "}
